...
!function( $ ) {
	...
	var Datetimepicker = function(element, options) {
		...
		this.component = this.element.is('.date') ? this.element.find('.add-on .aweso-calendar, .add-on .aweso-calendar-empty, .add-on .aweso-remove, .add-on .icomo-calendar-2, .add-on .icomo-calendar-3, .add-on .icomo-stopwatch, .add-on .icon-th, .add-on .icon-time, .add-on .icon-calendar').parent() : false;
